...
class VideoDecoderTest {
    ...
    fun timestampGuardRejectsDuplicateAndBackwardPresentationTimes() {
        ...
        assertThrows(VideoFailure.NonMonotonicTimestamp::class.java) { duplicate.accept(10L) }

        val backward = MonotonicTimestampGuard().apply { accept(10L) }
        assertThrows(VideoFailure.NonMonotonicTimestamp::class.java) { backward.accept(9L) }
    }
    ...
    fun decodedFrameDocumentsExplicitCopyForRetention() {
        ...
        assertTrue(frame.copyPixels() !== pixels)
    }
