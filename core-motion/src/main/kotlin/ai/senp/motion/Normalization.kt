...
internal enum class CoordinateSpace { IMAGE, WORLD }

internal enum class NormalizationStatus {
    NORMALIZED,
    MISSING_ANCHORS,
    DEGENERATE_SCALE,
...
internal class PoseNormalizer(private val minScale: Double = 1e-6) {
    init {
    ...
    private fun normalize(
        ...
        return NormalizationResult(
            frame = frame.copy(landmarks = normalized),
