...
internal enum class Coco17LandmarkId(val index: Int, val mediaPipeId: LandmarkId) {
...
internal data class Coco17Landmark(
    val image: Vec3?,
    val world: Vec3? = null,
...
internal data class Coco17Frame(
