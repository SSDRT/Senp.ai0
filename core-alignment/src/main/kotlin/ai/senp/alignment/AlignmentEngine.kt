...
internal class AlignmentEngine(private val config: AlignmentConfig = AlignmentConfig()) {
    fun align(
        user: MotionTrack,
        reference: MotionTrack,
        profile: ExerciseProfile,
        userPhaseOverride: PhaseState? = null,
        referencePhaseOverride: PhaseState? = null,
    ): AlignmentResult {
        ...
        val userPhase = userPhaseOverride ?: PhaseDetector.detect(user, profile, config)
        val referencePhase = referencePhaseOverride ?: PhaseDetector.detect(reference, profile, config)
